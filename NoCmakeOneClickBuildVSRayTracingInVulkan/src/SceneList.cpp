...
SceneAssets SceneList::CubeAndSpheres(CameraInitialSate& camera)
{
	...
	models.push_back(Model::LoadModel("models/cube_multi.obj"));
	...
	textures.push_back(Texture::LoadTexture("textures/land_ocean_ice_cloud_2048.png", Vulkan::SamplerConfig()));
...
SceneAssets SceneList::PlanetsInOneWeekend(CameraInitialSate& camera)
{
	...
	textures.push_back(Texture::LoadTexture("textures/2k_mars.jpg", Vulkan::SamplerConfig()));
	textures.push_back(Texture::LoadTexture("textures/2k_moon.jpg", Vulkan::SamplerConfig()));
	textures.push_back(Texture::LoadTexture("textures/land_ocean_ice_cloud_2048.png", Vulkan::SamplerConfig()));
...
SceneAssets SceneList::LucyInOneWeekend(CameraInitialSate& camera)
{
	...
	auto lucy0 = Model::LoadModel("models/lucy.obj");
	auto lucy1 = lucy0;
	auto lucy2 = lucy0;
