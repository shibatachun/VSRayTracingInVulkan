	...
	swapChain_(swapChain)
{
	...
	// Load shaders.
	const ShaderModule rayGenShader(device, "shaders/RayTracing.rgen.spv");
	const ShaderModule missShader(device, "shaders/RayTracing.rmiss.spv");
	const ShaderModule closestHitShader(device, "shaders/RayTracing.rchit.spv");
	const ShaderModule proceduralClosestHitShader(device, "shaders/RayTracing.Procedural.rchit.spv");
	const ShaderModule proceduralIntersectionShader(device, "shaders/RayTracing.Procedural.rint.spv");
